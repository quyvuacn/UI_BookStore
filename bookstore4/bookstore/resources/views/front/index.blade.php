...
{{--them div co class box--}}
								<div class="box">
                                    <a href="product/{{ $commicProduct->id }}" class="img">
                                        <img src="front/img/product/{{ $commicProduct->productImages[0]->path }}" alt="Image" class="img-fluid-2">
                                    </a>
                                </div>

								<div class="property-content">
                                    <div class="property-price">
                                        @if($commicProduct->discount != null)
                                            <div class="price mb-2">${{ $commicProduct->discount }} <span class="price-2">${{ $commicProduct->price }}</span></div>
                                        @else
                                            <div class="price mb-2">${{ $commicProduct->price }}</div>
                                        @endif
                                    </div>
...
{{--                    @endforeach--}}
					...
					<div class="item">
						<div class="testimonial">
							<img src="front/images/person_4-min.jpg" alt="Image" class="img-fluid rounded-circle w-25 mb-4">
							<div class="rate">
								<span class="icon-star text-warning"></span>
								<span class="icon-star text-warning"></span>
								<span class="icon-star text-warning"></span>
